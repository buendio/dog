            ...
            return v.prototype = Object.assign({}, v.prototype, {
                ...
                setupEventListeners: function() {
                    ...
                    i.$container.on("click.ntajax", ".t4s-active-filters a", function(e) {
                        ...
                        setTimeout("var title = document.getElementById('page-title').value;console.log(title);document.getElementById('title-page').innerHTML = title;", 1000);
                ...
                initPriceRange: function(e) {
                    ...
                    v.length < 1 || (a.hasClass("rtl_true") && (m = "rtl"), noUiSlider.create(g, {
                        start: [f, u],
                        connect: !0,
                        step: p,
                        direction: m,
